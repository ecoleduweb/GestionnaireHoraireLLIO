...
func TestUpdateUserRoleAsProjectManager(t *testing.T) {
	...
	w := sendRequest(router, "PATCH", fmt.Sprintf("/user/%d/role", testUser.Id), roleRequest, nil, enums.ProjectManager)
...
func TestUpdateUserRoleAsEmployee(t *testing.T) {
	...
	w := sendRequest(router, "PATCH", fmt.Sprintf("/user/%d/role", testUser.Id), roleRequest, nil, enums.Employee)
...
func TestUpdateOwnRole(t *testing.T) {
	...
	w := sendRequest(router, "PATCH", fmt.Sprintf("/user/%d/role", doNotDeleteUser.Id), roleRequest, nil, enums.Administrator)
...
func TestUpdateUserRoleWithInvalidID(t *testing.T) {
	...
	w := sendRequest(router, "PATCH", "/user/invalid/role", roleRequest, nil, enums.Administrator)
...
func TestUpdateUserRoleWithNonExistentUser(t *testing.T) {
	...
	nonExistentID := 99999
	w := sendRequest(router, "PATCH", fmt.Sprintf("/user/%d/role", nonExistentID), roleRequest, nil, enums.Administrator)
...
func TestUpdateUserRoleWithInvalidRole(t *testing.T) {
	...
	// Send request
	w := sendRequest(router, "PATCH", fmt.Sprintf("/user/%d/role", testUser.Id), roleRequest, nil, enums.Administrator)
...
func TestUpdateUserRoleMissingRoleField(t *testing.T) {
	...
	// Send request
	w := sendRequest(router, "PATCH", fmt.Sprintf("/user/%d/role", testUser.Id), emptyRequest, nil, enums.Administrator)
