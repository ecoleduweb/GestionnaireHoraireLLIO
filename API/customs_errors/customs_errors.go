...
var (
	...
	ErrProjectNoPermission         = errors.New("Impossible de faire cette action, l'utilisateur n'a pas l'autorisation pour interagir avec ce projet")
	ErrProjectCouldntModifyArchive = errors.New("Impossible d'archiver le projet, il y a eu une erreur avec la base de données")
