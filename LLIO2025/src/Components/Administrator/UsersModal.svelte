<script lang="ts">
  ...
  <div class=" p-4 flex flex-col items-center">
    ...
    <div class="mt-4 p-4 bg-gray-100 border-black-500 rounded shadow w-1/2">
      {#if isLoading}
        <p>Chargement...</p>
      {:else}
        <div class="flex flex-col gap-4 ">
          <div>
            ...
            <select id="userSelect" class="mt-1 block w-full border bg-white border-gray-300 rounded-md shadow-sm p-2" bind:value={selectedUser}>
            ...
            <select id="roleSelect" class="mt-1 block w-full border bg-white border-gray-300 rounded-md shadow-sm p-2" bind:value={selectedRole}>
